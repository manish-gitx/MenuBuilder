    ...
    <>
      ...
      <div className="fixed bottom-[108px] right-4 z-40">
        ...
        >
          ...
          <span
            className="text-[12px] font-semibold uppercase tracking-[2.4px]"
      ...
      {cart.length > 0 && (
        <div className="fixed bottom-4 left-4 right-4 z-40">
          <div
            className="border border-[rgba(255,255,255,0.05)] rounded-[16px] p-[17px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] flex items-center justify-between gap-3"
          ...
          >
            ...
            >
              ...
              <div className="min-w-0">
                <p
                  className="text-[10px] font-semibold uppercase tracking-[1px] leading-none mb-[2px]"
            ...
            <button
              onClick={onShowConfirm}
              className="flex-shrink-0 rounded-[8px] px-[32px] py-[12px] text-[12px] font-bold uppercase tracking-[1.2px] shadow-[0px_4px_15px_0px_rgba(255,185,90,0.3)]"
